...
<head>
    ...
    <title>event registration - ECE</title>
    
</head>
<?php
 include ("config.php");
 include ("nav.php");
 if (isset($_POST["ecereg_submit"]))
 {
    $rname = $_POST["rname"];
    ...
    elseif(strlen($sec)!=1)
    {
        ...
        $check_remail = "SELECT email,phone_number,roll_no FROM ecereg WHERE email = '$remail' || phone_number = '$rphone' || roll_no = '$rroll';";
        ...
        {
            $insertreg = "INSERT INTO ecereg(name,phone_number,email,roll_no,college,section) VALUES('$rname','$rphone','$remail','$rroll','$college','$sec');";
...
<body style="background :url('ece.jpg')" >
    
    <form action="ecereg.php" method="post">
    ...
    <table style="background-color: #f1f1f18a;">
        ...
        <tr>
            ...
            <td><input type="submit" value="register" name="ecereg_submit" class="submit"></td>
        </tr>
